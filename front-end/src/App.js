...
import FormFuncionarios from "./components/dashboard/funcionarios/Form";
...
import FormVendas from "./components/dashboard/vendas/FormVendas";
  ...
  return (
    <div className={`App ${styles.app}`}>
      <Routes>
        ...
        <Route path="/funcionarios/adicionar" element={<FormFuncionarios />} />
        <Route path="/clientes" element={<Clientes />} />
        <Route path="/sapatos" element={<Sapatos />} />
        <Route path="/vendas" element={<Vendas />} />
        <Route path="/vendas/adicionar" element={<FormVendas />} />
      </Routes>
    </div>
  );
}
